...
export default function ResearchDashboard() {
  ...
  return <main className="research-page">
    <div className="research-header"><div><p className="eyebrow">MPA-Index</p><h1>Researcher dashboard</h1><p>Core questionnaire completion, route distribution, and CSV export.</p></div><a href="/" className="secondary-button">← Participant questionnaire</a></div>
    ...
    {summary && <>
      <div className="research-toolbar"><span>Core MPA data only.</span><div><button className="secondary-button" onClick={() => void downloadCsv()} type="button">Export CSV</button><button className="secondary-button" onClick={() => void load()} type="button">Refresh</button></div></div>
